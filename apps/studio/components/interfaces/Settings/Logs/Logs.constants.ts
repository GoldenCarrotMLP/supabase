...
export const SQL_FILTER_TEMPLATES: any = {  
  ...
  edge_logs: {   
    ...
    'product.database': `REGEXP_CONTAINS(request.path, '^/rest/') or REGEXP_CONTAINS(request.path, '^/graphql/')`,  
    'product.storage': `REGEXP_CONTAINS(request.path, '^/storage/')`,  
    'product.auth': `REGEXP_CONTAINS(request.path, '^/auth/')`,  
    'product.realtime': `REGEXP_CONTAINS(request.path, '^/realtime/')`,  
  ...
  supavisor_logs: {  
    ..._SQL_FILTER_COMMON,  
    database: (value: string) => `REGEXP_CONTAINS(m.project, '^${value}')`,  
  },  
  pg_upgrade_logs: {  
    ..._SQL_FILTER_COMMON,  
  },  
